...
export const AI_PROVIDER: "gemini" | "gpt" = rawProvider === "openai" || rawProvider === "gpt" ? "gpt" : "gemini";
export const AI_API_VERSION = process.env.AI_API_VERSION ?? "v1beta";
export const GPT_ENDPOINT = process.env.AI_ENDPOINT ?? "https://api.openai.com/v1/chat/completions";
